...
public class FahrenheitCelsiusTest extends junit.framework.TestCase {
    ...
    public void test_fahrenheitEnCelsiusVersionAssertTrue() {
        assertTrue(" 0 ?F -> -17.7 ?C ? ", FahrenheitCelsius.fahrenheitEnCelsius(0) == -17.7f);
        assertTrue(" 100 ?F -> 37.7 ?C ? ", FahrenheitCelsius.fahrenheitEnCelsius(100) == 37.7f);
    }
